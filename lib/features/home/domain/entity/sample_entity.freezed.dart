...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SampleEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
class _SampleEntity implements SampleEntity {
  ...
  factory _SampleEntity.fromJson(Map<String, dynamic> json) => _$SampleEntityFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$SampleEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SampleEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
