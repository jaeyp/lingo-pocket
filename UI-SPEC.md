...
│  [EN→KO]                       [▶] │ ← 토글, 낱장보기
├─────────────────────────────────────┤
│  Sort: Random ▼  Difficulty: All ▼ │ ← 정렬/난이도 필터
├─────────────────────────────────────┤
│  ┌───────────────────────────────┐ │║
...
**필드 목록:**
1. ✅ `sentence` (영어 문장) - 필수, 여러 줄
2. ✅ `translation` (한국어 번역) - 필수, 여러 줄
...
│  │ seeing you.               │ │
│  └───────────────────────────┘ │
│  [B] [H]                        │ ← Bold, Highlight 버튼
│                                 │
│  미리보기:                      │
│  I'm looking forward to seeing  │ ← 렌더링된 결과
│  you.                           │
└─────────────────────────────────┘
```
